...
{
    class YuvarlakButon2:Button
    {
        protected override void OnPaint(PaintEventArgs pevent)
        {
            base.OnPaint(pevent);
            int radius = 45; // Çemberin çapı
            ...
            LinearGradientBrush brush = new LinearGradientBrush(circleRect, Color.Red, Color.PaleVioletRed, 90); // Çemberi boyamak için doğrusal gradyan fırça - Değerler: Boyanacak alan, Birinci geçiş rengi, İkinci geçiş rengi, geçiş açısı
