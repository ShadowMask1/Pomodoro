...
namespace Yuvarlak_Buton
{
    class YuvarlakButon:Button
    {
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            LinearGradientBrush brush = new LinearGradientBrush(circleRect, Color.Orange, Color.OrangeRed, 90); // Çemberi boyamak için doğrusal gradyan fırça - Değerler: Boyanacak alan, Birinci geçiş rengi, İkinci geçiş rengi, geçiş açısı
